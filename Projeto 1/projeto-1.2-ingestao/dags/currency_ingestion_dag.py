...
from __future__ import annotations #ajuda o python a lidar melhor com tipos

import logging # serve para escrever os logs, como um diário
from datetime import datetime, timedelta

from airflow.decorators import dag, task 

logger = logging.getLogger(__name__) # cria um registrador pra escrever logs 
